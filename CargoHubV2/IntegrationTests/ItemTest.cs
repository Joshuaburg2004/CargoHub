...
public class ItemIntegratieTest : BaseTest
{
    ...
    public async Task GetItemInventories()
    {
        ...
        HttpResponseMessage postInventoryResponse = await _client.PostAsJsonAsync("/api/v2/inventories", TestInventory);
        ...
        HttpResponseMessage responsedelete = await _client.DeleteAsync("/api/v2/inventories/5");
