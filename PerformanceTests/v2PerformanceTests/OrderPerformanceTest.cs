...
{
    public class OrderPerformanceTestB2 : BaseTest
    {
        public string requestUri = $"{RequestUri}/api/v2/orders";
        [Fact]
        ...
        [Fact]
        public void GetOrderedItems10Users2RequestsPerformanceTest()
        {
            var stats = TestPlan(
                ThreadGroup(10, 2,
