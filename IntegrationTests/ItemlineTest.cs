...
namespace IntegrationTests
{
    ...
    {
        private ItemLine _itemLineCreate = new ItemLine(1, "Book", "Never gonna give you up");
        private ItemLine _itemLinePut = new ItemLine(1, "Book", "Never gonna let you down");
